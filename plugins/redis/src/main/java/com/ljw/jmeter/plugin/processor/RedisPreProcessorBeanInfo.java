 ...
 * @author 林杰炜 linjw
 *  redis前置处理器Gui
 * @Description redis前置处理器Gui
 * @date 2018/12/18 19:54
 */
public class RedisPreProcessorBeanInfo extends BeanInfoSupport {
    private static final Logger log = LoggerFactory.getLogger(RedisPreProcessorBeanInfo.class);
    ...
    public RedisPreProcessorBeanInfo(){
        super(RedisPreProcessor.class);
        ...
        try {
            ...
            log.error("init Redis Pre Processor Gui error");
        }
    }
}
